...
<form:hidden path="id"/>
	...
	<table>
		...
		<c:forEach items="${page.content}" var="role">
			<tr>
				<td>${role.role}</td>
				<td>
					<a href="/admin/role/delete/${role.id}?page=${page.number+1}&size=${page.size}&sort=${param['sort']}">delete</a>
				</td>
				<td>
	...
	<table>
		...
		<tr>
			<td><a href="?page=1&size=${page.size}&sort=role">Name asc</a></td>
			<td><a href="?page=1&size=${page.size}&sort=role,desc">Name
					desc</a></td>
		</tr>
	</table>
<hr>

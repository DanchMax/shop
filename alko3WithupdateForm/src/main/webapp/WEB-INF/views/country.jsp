	...
	<div class="row-fluid">
		...
		<div class="col-md-7">
			<form:form action="/admin/country" method="post" class="form-inline" 
				...
				<form:hidden path="id" />
				<custom:hiddenInputs excludeParams="country, id"/>
				<div class="form-group">
					<label for="country"><form:errors path="country" /></label>
					<form:input id="country" path="country" placeholder="country name" class="form-control" />
			...
			<c:forEach items="${page.content}" var="country">
				<div class="col-md-4">${country.country}</div>
				<div class="col-md-4">
